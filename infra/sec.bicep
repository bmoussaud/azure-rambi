...
param keyVaultName string = 'abcdefghij'
...
param secretName string = 'scott'

@description('Specifies the value of the secret that you want to create.')
@secure()
param secretValue string = 'tiger'
...
@description('Creates an Azure Key Vault Secret AZURE_OPENAI_ENDPOINT.')
resource secret2 'Microsoft.KeyVault/vaults/secrets@2021-04-01-preview' = {
  parent: kv
