...
poster_description="The poster showcases a vibrant rural landscape with lush green cabbage fields stretching into the distance under a radiant pink and blue sky. In the foreground, a stylish vintage convertible car is parked beside a charming farmhouse, symbolizing the blend of rustic and modern. Two couples are featured: one couple shares a joyful laugh near the car, dressed in fashionable yet casual outfits, while the other couple enjoys a romantic moment under a blossoming tree. Bright and warm colors dominate the scene, with subtle sparkles and soft lighting adding a magical and uplifting feel. The overall aesthetic is lively and heartwarming, capturing the essence of love and friendship in a picturesque setting. 


Reuse the 2 attached images to find the key symbols and elements to include in the new poster."
